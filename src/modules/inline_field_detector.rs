...
impl AnalysisModule for InlineFieldDetector {
    ...
    fn process(&self, doc: &mut Document) {
        ...
        let inline_fields: Vec<usize> = field_groups.iter()
            .filter(|&&idx| {
    ...
    fn test_inline_field_with_text_right() {
        ...
        let flattened = Flattened::from_nodes(
            ...
            vec![
                FlattenedNode::new_field(
                    "TF_Name".to_string(), "".to_string(), "Name".to_string(),
                    num(10.0), num(98.0), num(100.0), num(20.0),
                ),
                FlattenedNode::new_text(
                    "is required".to_string(), num(10.0), "Helvetica".to_string(),
                    num(115.0), num(100.0), num(60.0), num(12.0),
                ),
            ],
        );
        ...
        let flattened = Flattened::from_nodes(
            ...
            vec![
                ...
                FlattenedNode::new_text(
                    ...
                    num(75.0), num(80.0), num(40.0), num(12.0),
                ),
                // Text to the left
                FlattenedNode::new_text(
                    "Enter:".to_string(), num(10.0), "Helvetica".to_string(),
                    num(10.0), num(100.0), num(40.0), num(12.0),
                ),
                FlattenedNode::new_field(
                    "TF_Name".to_string(), "".to_string(), "Name".to_string(),
                    num(75.0), num(98.0), num(100.0), num(20.0),
    ...
    fn test_not_inline_without_adjacent_text() {
        ...
        let flattened = Flattened::from_nodes(
            ...
            vec![
                FlattenedNode::new_field(
                    "TF_Name".to_string(), "".to_string(), "Name".to_string(),
                    num(200.0), num(200.0), num(100.0), num(20.0),
                ),
                // Text far away
                FlattenedNode::new_text(
                    "Some text".to_string(), num(10.0), "Helvetica".to_string(),
                    num(10.0), num(500.0), num(60.0), num(12.0),
                ),
            ],
        );
    ...
    fn test_inline_field_contained_in_text_block() {
        ...
        let flattened = Flattened::from_nodes(
            ...
            vec![
                ...
                FlattenedNode::new_text(
                    "Please enter your".to_string(), num(10.0), "Helvetica".to_string(),
                    num(10.0), num(100.0), num(100.0), num(12.0),
                ),
                // Field embedded in the text flow (overlapping horizontal range)
                FlattenedNode::new_field(
                    "TF_Name".to_string(), "".to_string(), "Name".to_string(),
                    num(50.0), num(98.0), num(60.0), num(20.0),
                ),
            ],
        );
    ...
    fn test_not_inline_when_label_above_and_text_overlapping() {
        ...
        let flattened = Flattened::from_nodes(
            ...
            vec![
                ...
                FlattenedNode::new_text(
                    "Name:".to_string(), num(10.0), "Helvetica".to_string(),
                    num(50.0), num(75.0), num(40.0), num(12.0),
                ),
                // Text on the SAME LINE as field that overlaps horizontally
                FlattenedNode::new_text(
                    "required".to_string(), num(10.0), "Helvetica".to_string(),
                    num(10.0), num(100.0), num(35.0), num(12.0),
                ),
                // Field with label above
                FlattenedNode::new_field(
                    "TF_Name".to_string(), "".to_string(), "Name".to_string(),
                    num(50.0), num(98.0), num(100.0), num(20.0),
                ),
            ],
        );
