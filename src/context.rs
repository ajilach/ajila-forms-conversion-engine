...
//! basic information (language) and is enriched by modules throughout processing.
...
/// 
/// This struct starts with basic information (language) and is enriched by
/// analysis modules as the document is processed. The final context is
/// included in the structured output as metadata.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct Context {
    /// Document language (e.g., "de", "en", "fr")
    pub language: String,
...
mod tests {
    ...
    fn test_context_creation() {
        let ctx = Context::new("de".to_string());
    ...
    #[test]
    fn test_module_data() {
        let mut ctx = Context::new("en".to_string());
    ...
    fn test_context_serialization() {
        let mut ctx = Context::new("fr".to_string());
